...
impl Scene {
    ...
    fn show_sidebar(&mut self, ui: &mut egui::Ui, ctx: &mut EditorContext) {
        ...
        ScrollArea::vertical().id_salt("metadata").show(ui, |ui| {
            ...
            match scene_data.sidebar_tab {
                SidebarTab::Notes => {
                    self.show_sidebar_metadata(ui, ctx);
                }
                SidebarTab::Export => {
                    self.show_sidebar_export(ui);
                }
            }
        });
    }

    fn show_sidebar_metadata(&mut self, ui: &mut egui::Ui, ctx: &mut EditorContext) {
    ...
    fn show_sidebar_export(&mut self, ui: &mut egui::Ui) {
